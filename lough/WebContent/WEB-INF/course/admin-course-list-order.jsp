		...
		<tr>
			...
			<td height="414" align="center">
				<table border="1" cellspacing="0">
									<s:if test="#request.courses == null || #request.courses.size ==0">无信息</s:if>
					<tr>
						<td>id</td>
						<td>课程号</td>
						<td>课程名</td>
            ...
            第一页  上一页
								...
								<a href="course-listChooseByCourseOrderByCount.action?page=1">第一页</a>
								<a
									href="course-listChooseByCourseOrderByCount.action?page=<s:property value="%{currentPage-1}"/>">上一页</a>
							</s:else> <s:if test="%{currentPage != totalPage}">
								<a
									href="course-listChooseByCourseOrderByCount.action?page=<s:property value="%{currentPage+1}"/>">下一页</a>
								<a
									href="course-listChooseByCourseOrderByCount.action?page=<s:property value="totalPage"/>">最后一页</a>
							</s:if> <s:else>
          下一页  最后一页
         </s:else>
						</td>
